...
public class ExamResultsExtended {
    ...
    public static void main(String[] args) {
        ...
        sortByMark(resultsArray, pass);
        output(resultsArray);

        sortByName(resultsArray, pass);
        output(resultsArray);
    }
    ...
    public static void sortByMark(Result[] array, int pass) {
...
//        }
    ...
    public static void sortByName(Result[] array, int pass) {
//        for (int pass = 1; pass < array.length; pass++) {
        if (pass < array.length) {
            int firstElement = pass - 1;
